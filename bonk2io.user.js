// ==UserScript==
// @name         Bonk2.io Jump HACK - Bonkio Hacks - Best Bonk Cheat 2019 to 2020
// @description  Bonk2io Mods Features: Jump Hack, Faster Movement, Auto Jump, Free Skins, FPS, Adblock
...
// @updateURL    https://io-mods.com/mods/bonk2io.user.js
// @downloadURL  https://io-mods.com/mods/bonk2io.user.js
// @grant          GM_setValue
// @grant          GM_getValue
// @match        *://bonk2.io/*
// @match        *iogames.space/*
...
//degisenkisimlar
$('#bonkioheader').html('<center><div style="'+this.st.fpsstyle+'" id="fps" class="fps"></div></center>');
$('#cpms_l').html('<div style="'+this.st.formstyle+'"><div class="option1"></div></div></br>');
$('#pagecontainer').prepend('<div class="list1"></div>');
    $("#cpms_l").css({"width": "255px"});
...
document.getElementById("guestOrAccountContainer").prepend(stylerSelect);
...
function changebackground() {
    ...
    $("#pagecontainer").css("background-color",rgbaC2);
}
...
function colorfulmod() {
    ...
    colorsrain = ["transparent"];
      ...
      setInterval(function() {
          ...
          $("#pagecontainer").css("background-color",rgbaCol);
      }, 3000);
}
